        ...
        child: Column(
          ...
          children: [
            ...
            if (b.averageRating != null)
              Text(
                'Ortalama Puan: ${b.averageRating} (${b.ratingsCount ?? 0} oy)',
                textAlign: TextAlign.center,
                style: GoogleFonts.openSans(
                  fontSize: 14,
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      _isFav ? 'Favorilerden Çıkar' : 'Favorilere Ekle',
                    ),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      _inLib ? 'Kütüphaneden Çıkar' : 'Kütüphaneye Ekle',
                    ),
