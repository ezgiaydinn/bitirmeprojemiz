      ...
      final recBooks =
          rawRecs.map((rec) {
            return Book(
              ...
              thumbnailUrl: rec['thumbnailUrl'] as String? ?? '',
        ...
        MaterialPageRoute(
          builder:
              (_) => RecommendationsScreen(
                ...
                onRate:
                    (b, r) => setState(() => _userRatings[b.id] = r.toDouble()),
              ),
        ),
      );
    } catch (e) {
                                        ...
                                        MaterialPageRoute(
                                          builder:
                                              (_) => BookDetailScreen(
                                                userId: widget.userId,
                                                book: b,
                                                isFavorite: _favoriteBooks.any(
                                                  (x) => x.id == b.id,
                                                ),
                                                isInLibrary: _libraryBooks.any(
                                                  (x) => x.id == b.id,
                                                ),
                                                userRating: rInt,
                                                onToggleFavorite: (bx) {
